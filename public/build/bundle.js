    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div4, "class", "input-group-text svelte-ushuwi");
    			add_location(div4, file$3, 86, 12, 2915);
    			attr_dev(div5, "class", "input-group-prepend");
    			add_location(div5, file$3, 85, 10, 2869);
    			...
    			attr_dev(input0, "class", "form-control svelte-ushuwi");
    			add_location(input0, file$3, 90, 10, 3018);
    			attr_dev(div6, "class", "input-group mb-1 mt-0");
    			add_location(div6, file$3, 84, 8, 2823);
    			attr_dev(div7, "class", "col-6 pl-0 pr-0");
    			add_location(div7, file$3, 83, 4, 2785);
    			attr_dev(div8, "class", "input-group-text svelte-ushuwi");
    			add_location(div8, file$3, 101, 12, 3482);
    			attr_dev(div9, "class", "input-group-prepend");
    			add_location(div9, file$3, 100, 10, 3436);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "Main content ID (example: content-hotelalmirante)");
    			attr_dev(input1, "class", "form-control svelte-ushuwi");
    			add_location(input1, file$3, 105, 10, 3587);
    			attr_dev(div10, "class", "input-group mb-1 mt-0");
    			add_location(div10, file$3, 99, 7, 3390);
    			attr_dev(div11, "class", "col-6 pl-0 pr-0");
    			add_location(div11, file$3, 98, 4, 3353);
    			attr_dev(div12, "class", "row");
    			add_location(div12, file$3, 82, 3, 2763);
    			attr_dev(div13, "id", "editor");
    			attr_dev(div13, "class", "app-editor svelte-ushuwi");
    			add_location(div13, file$3, 118, 8, 3950);
    			attr_dev(div14, "class", "col-6 pl-1 pr-0");
    			add_location(div14, file$3, 117, 6, 3912);
    			attr_dev(iframe, "id", "viewer");
    			if (iframe.src !== (iframe_src_value = /*ifrSrc*/ ctx[0])) attr_dev(iframe, "src", iframe_src_value);
    			attr_dev(iframe, "frameborder", "0");
    			attr_dev(iframe, "class", "svelte-ushuwi");
    			add_location(iframe, file$3, 121, 7, 4049);
    			attr_dev(div15, "class", "col-6 pl-1 pr-0");
    			add_location(div15, file$3, 120, 6, 4012);
    			attr_dev(div16, "class", "row");
    			add_location(div16, file$3, 116, 4, 3888);
    			attr_dev(div17, "class", "container-fluid");
    			add_location(div17, file$3, 47, 2, 1402);
    			add_location(section, file$3, 46, 1, 1390);
    			attr_dev(main, "class", "svelte-ushuwi");
